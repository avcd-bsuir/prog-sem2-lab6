...
Создайте строку. Проанализировав в программе содержимое строки, создайте одну очередь однозначных чисел, а вторую очередь двузначных чисел. Перемножьте соответственные элементы двух очередей и организуйте третью очередь. Результат выведите на экран. Решение в программе оформляйте через подпрограммы.
